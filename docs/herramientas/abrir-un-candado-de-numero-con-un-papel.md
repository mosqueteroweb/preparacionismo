# Abrir un candado de número con un papel


Vídeo práctico: cómo abrir una cerradura de número (candado de combinación) usando solo un papel. Truco de "daily life hacks" útil como recurso de manipulación básica.


<video controls width="100%" preload="metadata" style="border:1px solid #ccc;border-radius:8px;">
  <source src="../video/abrir-candado-papel.mp4" type="video/mp4">
