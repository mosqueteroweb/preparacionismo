...
**Descargar:** [Manual_PMR_walkies.pdf](../pdf/Manual_PMR_walkies.pdf) (1,5 MB)

<iframe src="../pdf/Manual_PMR_walkies.pdf" width="100%" height="600" style="border:1px solid #ccc;border-radius:8px;"></iframe>
...
1. **Modo de descifrado ordinario:**
   1. Con el equipo apagado, mantener pulsadas PTT + ON/OFF hasta oír tres pitidos "dididi" y ver parpadear alternamente los indicadores rojo/verde → entra en "Etapa 1 de medición de frecuencia".
   1. Cambiar de canal con el interruptor de codificación → "Etapa 2".
   1. Transmitir continuamente con el walkie objetivo; al oír "da" con dos destellos rojos, la frecuencia queda guardada en el canal actual y ya pueden hablar.
1. **Modo de descifrado súper:** igual pero pulsando PTT + MONI (▲) + ON/OFF. Tarda más; reintentar si falla la primera vez.
1. **Tono final "croak":** se activa/desactiva (sonidos "di" / "didi") manteniendo ▲ + ON/OFF al encender.
